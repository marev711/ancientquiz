...
export default function MapView({
  ...
  const onMapClick = (e: LeafletMouseEvent) => {
    if (mode === 'guess-location') onGuess(e.latlng.lat, e.latlng.lng);
  };
  ...
  return (
    <div className="h-[70vh] md:h-[75vh] w-full rounded-2xl overflow-hidden shadow">
      ...
      >
        ...
        {mode === 'identify-marker' && places.map((p) => (
        ...
        {mode === 'guess-location' && lastResult && target && (
          <CircleMarker
            ...
            radius={9} weight={3} fillOpacity={0.6}
          >
